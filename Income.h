...
public:
    ...
    Income(int incomes_id = 0, int logged_users_id = 0, int int_date = 0, float amount_in_float = 0, string amount_of_income = "", string incomes_title = "", string string_date = ""){

        this -> incomes_id = incomes_id;
        this -> logged_users_id = logged_users_id;
        this -> amount_in_float = amount_in_float;
    ...
    void set_amount_in_float(float new_amount);
